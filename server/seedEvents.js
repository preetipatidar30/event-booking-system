...
const dummyEvents = [
    ...
    {
        title: "AI & Web Development Conference 2025",
    ...
    },
    {
        ...
        description: "Witness the thrilling finale of IPL 2025! The best teams battle it out for the championship trophy.",
        category: "sports",
...
const seedDatabase = async () => {
    try {
        ...
        // First, find or create an admin user to be the creator
        ...
        console.log(`✅ Successfully added ${result.length} events to the database!`);

        console.log('\nAdded events:');
        result.forEach((event, index) => {
            console.log(`  ${index + 1}. ${event.title} - ${event.category} (Featured: ${event.isFeatured})`);
        });
